...
//        String q = "/ViewReview?turf_id="+ViewTurf.turf_ids+"&login_id="+Login.lid;
        String q = "/ViewReview?exp_id="+view_experts.eid+"&lid="+sh.getString("login_id", "");
        q=q.replace(" ", "%20");
        JR.execute(q);
...
//                String q = "/Review?turf_id="+ViewTurf.turf_ids+"&rating="+rating+"&review="+review+"&login_id="+Login.logid;
                String q = "/rate_e?&rating="+rating+"&review="+review+"&exp_id="+view_experts.eid+"&lid="+sh.getString("login_id", "");
                JR.execute(q);
                Log.d("pearl",q);
            }
        });
    ...
    public void onBackPressed()
    {
        // TODO Auto-generated method stub
        super.onBackPressed();
        Intent b=new Intent(getApplicationContext(),view_experts.class);
        startActivity(b);
    }
